...
public class DigitalClockGUI extends JFrame {
	...
	private static final ClockLogic Clocklogic = null;
	...
	public DigitalClockGUI() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(DigitalClockGUI.class.getResource("/img/AlarmClockImage.png")));
		...
		btnSetAlarm.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
			    ...
			    if (hourCheck < 0 || hourCheck > 23 || minuteCheck < 0
			      || minuteCheck > 59) {
			     lblErrorMsg.setText("NEIN NEIN NEIN!");
			    } else {
			     String zero4 = "";
			     String zero5 = "";
